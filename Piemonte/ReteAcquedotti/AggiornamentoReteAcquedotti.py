...
os.chdir( '/Users/andrea/PycharmProjects/Acqua/Piemonte/ReteAcquedotti' )

geoJsonFile = 'ConfiniComuniPiemonte.geojson'
geoJsonFile_standardized = 'rete_acquedotti_piemonte.geojson'
regione = 'Piemonte'
