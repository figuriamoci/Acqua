...
os.chdir( '/Users/andrea/PycharmProjects/Acqua/Trentino/ReteAcquedotti' )

geoJsonFile = 'ConfiniComuniTrentino.geojson'
geoJsonFile_standardized = 'rete_acquedotti_trentino.geojson'
regione = 'Trentino'
