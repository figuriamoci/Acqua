...
os.chdir( '/Users/andrea/PycharmProjects/Acqua/EmiliaRomagna/ReteAcquedotti' )
geoJsonFile = 'ConfiniComuniER.geojson'
geoJsonFile_standardized = 'rete_acquedotti_ER.geojson'
